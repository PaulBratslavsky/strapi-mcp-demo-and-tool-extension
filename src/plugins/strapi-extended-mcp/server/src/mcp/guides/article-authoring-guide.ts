// Inlined copy of article-authoring-guide.md (frontmatter stripped). Source of
// truth: the .md file in this folder. If you edit it, mirror the change here —
// vite does not bundle .md files into the plugin's dist output.

export const ARTICLE_AUTHORING_GUIDE_MD = String.raw`# Blog Post Template
